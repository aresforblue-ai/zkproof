...
def generate_merkle_proof(leaf_index: int, tree_levels: List[List[str]], depth: int = 16) -> Tuple[List[str], List[int]]:
    """
...
def verify_merkle_proof(leaf: str, root: str, path_elements: List[str], path_indices: List[int]) -> bool:
