...
class DifferentialPrivacy:
    ...
    def private_sum(self, true_sum: float, max_value: float, epsilon: Optional[float] = None) -> float:
        """
    ...
    def reset_privacy_budget(self, new_epsilon: Optional[float] = None, new_delta: Optional[float] = None) -> None:
        """
